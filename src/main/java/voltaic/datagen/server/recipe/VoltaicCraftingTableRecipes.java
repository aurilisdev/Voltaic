...
public class VoltaicCraftingTableRecipes extends AbstractRecipeGenerator {
	 ...
	 * .addIngredient(Items.GLASS_BOTTLE) // .addIngredient(Items.GLASS_BOTTLE) //
	 * .addIngredient(Items.GLASS_BOTTLE) // .addIngredient(ItemTags.FISHES) //
	 ...
	 * .addIngredient(Tags.Items.GEMS_AMETHYST) //
	 * .addIngredient(Tags.Items.GEMS_AMETHYST) // .addIngredient(ItemTags.FISHES)
	 * // .addConditions(new NotCondition(new
	 * ModLoadedCondition(ELECTRODYNAMICS_ID))) // .complete(Voltaic.ID,
	 * "iodinetablet", output);
	 * 
	 */
