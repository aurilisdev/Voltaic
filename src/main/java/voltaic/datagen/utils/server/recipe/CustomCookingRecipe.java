...
public class CustomCookingRecipe implements FinishedRecipe {
    ...
    private CustomCookingRecipe(ResourceLocation id, Ingredient input, Item result, float experience, int cookingTime,
	...
	private Builder(Item result, float experience, int smeltTime,
		RecipeSerializer<? extends AbstractCookingRecipe> serializer) {
	    this.result = result;
	    this.experience = experience;
	...
	public void complete(String parent, String name, Consumer<FinishedRecipe> consumer) {
	    consumer.accept(new CustomCookingRecipe(new ResourceLocation(parent, name), input, result, experience,
		    smeltTime, serializer));
	}
