...
public class FinishedRecipeGasOutput extends FinishedRecipeBase {
    ...
    private FinishedRecipeGasOutput(RecipeSerializer<?> serializer, GasStack output, double experience, int processTime,
	    double usagePerTick) {
    ...
    public static FinishedRecipeGasOutput of(RecipeSerializer<?> serializer, GasStack output, double experience,
	    int processTime, double usage) {
