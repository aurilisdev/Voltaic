...
public class CustomSingleItemRecipeBuilder extends SingleItemRecipeBuilder.Result {
    ...
    public CustomSingleItemRecipeBuilder(ResourceLocation id, RecipeSerializer<?> recipe, Ingredient input, Item result,
	    int count) {
	...
	public void complete(String parent, String name, Consumer<FinishedRecipe> consumer) {
	    consumer.accept(new CustomSingleItemRecipeBuilder(new ResourceLocation(parent, name), serializer, input,
		    result, count));
	}
