...
public class FinishedRecipeItemOutput extends FinishedRecipeBase {
    ...
    private FinishedRecipeItemOutput(RecipeSerializer<?> serializer, ItemStack stack, double experience,
    ...
    public static FinishedRecipeItemOutput of(RecipeSerializer<?> serializer, ItemStack output, double experience,
	    int processTime, double usage) {
