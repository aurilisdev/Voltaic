...
public abstract class BaseLootTablesProvider extends AbstractLootTableProvider {
    ...
    public <T extends GenericTile> void addMachineTable(Block block, RegistryObject<BlockEntityType<T>> tilereg,
    ...
    public void addFortuneAndSilkTouchTable(RegistryObject<? extends Block> reg, Item nonSilk, int minDrop,
	    int maxDrop) {
