...
public abstract class BaseBlockstateProvider extends BlockStateProvider {
    ...
    public ItemModelBuilder simpleBlock(RegistryObject<? extends Block> block, ResourceLocation texture,
    ...
    public ItemModelBuilder glassBlock(RegistryObject<? extends Block> block, ResourceLocation texture,
	    boolean registerItem) {
    ...
    public ItemModelBuilder simpleBlockCustomRenderType(RegistryObject<? extends Block> block, ResourceLocation texture,
	    ResourceLocation renderType, boolean registerItem) {
	return simpleBlockCustomRenderType(block.get(), texture, renderType, registerItem);
    }

    public ItemModelBuilder airBlock(RegistryObject<? extends Block> block, String particleTexture,
	    boolean registerItem) {
    ...
    public ItemModelBuilder bottomSlabBlock(RegistryObject<? extends Block> block, ResourceLocation side,
    ...
    public ItemModelBuilder horrRotatedBlock(RegistryObject<? extends Block> block, ModelFile modelFile,
	    boolean registerItem) {
    ...
    public ItemModelBuilder horrRotatedLitBlock(RegistryObject<? extends Block> block, ModelFile off, ModelFile on,
	    boolean registerItem) {
    ...
    public ItemModelBuilder redstoneToggleBlock(RegistryObject<? extends Block> block, ModelFile off, ModelFile on,
	    boolean registerItem) {
	...
	ModelFile model = models().withExistingParent(name(block), Voltaic.vanillarl("cube"))
		...
		.renderType(Voltaic.vanillarl("cutout"));
    ...
    public ItemModelBuilder crossBlock(RegistryObject<? extends Block> block, ResourceLocation texture,
	    @Nullable ResourceLocation renderType, boolean registerItem) {
    ...
    public BlockModelBuilder blockTopBottom(RegistryObject<? extends Block> block, String top, String bottom,
	    String side) {
	return models().cubeBottomTop(BuiltInRegistries.BLOCK.getKey(block.get()).getPath(),
