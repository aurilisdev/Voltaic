...
public abstract class BaseItemModelsProvider extends ItemModelProvider {
    ...
    public void toggleableItem(DeferredHolder<Item, ? extends Item> item, String toggle, Parent parentOff,
    ...
    public DynamicFluidContainerModelBuilder<ItemModelBuilder> getBucketModel(DeferredHolder<Item, ? extends Item> item,
	    Parent parent) {
