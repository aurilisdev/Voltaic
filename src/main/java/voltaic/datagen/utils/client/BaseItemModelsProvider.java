...
public abstract class BaseItemModelsProvider extends ItemModelProvider {
    ...
    public void toggleableItem(RegistryObject<? extends Item> item, String toggle, Parent parentOff, Parent parentOn,
    ...
    public DynamicFluidContainerModelBuilder<ItemModelBuilder> getBucketModel(RegistryObject<? extends Item> item,
	    Parent parent) {
