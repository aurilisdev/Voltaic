...
public abstract class BaseItemModelsProvider extends ItemModelProvider {
    ...
    public <T extends Item> void layeredItem(RegistryObject<T> item, Parent parent, ResourceLocation... textures) {
    ...
    public <T extends Item> void toggleableItem(RegistryObject<T> item, String toggle, Parent parentOff,
	    Parent parentOn, ResourceLocation[] offText, ResourceLocation[] onText) {
    ...
    public <T extends Item> DynamicBucketModelBuilder<ItemModelBuilder> getBucketModel(RegistryObject<T> item,
	    Parent parent) {
    ...
    public <T extends Item> String name(RegistryObject<T> item) {
