...
public class IngredientRendererGasStack implements IIngredientRenderer<GasStack> {
	...
	graphics.blit(bars.getLocation(), bars.getXOffset(), mercuryOffset + bars.getYOffset(), bars.textureU(),
		bars.textureV(), bars.textureWidth(), bars.textureHeight(), bars.imageWidth(), bars.imageHeight());
