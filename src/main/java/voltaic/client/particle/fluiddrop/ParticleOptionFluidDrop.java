...
public class ParticleOptionFluidDrop extends ParticleType<ParticleOptionFluidDrop> implements ParticleOptions {
    ...
    public static final MapCodec<ParticleOptionFluidDrop> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ParticleOptionFluidDrop> STREAM_CODEC = StreamCodec
