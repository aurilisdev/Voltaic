...
public class ParticleOptionFluidDrop extends ParticleType<ParticleOptionFluidDrop> implements ParticleOptions {
    ...
    public static final Codec<ParticleOptionFluidDrop> CODEC = RecordCodecBuilder.create(instance -> instance
	...
	public ParticleOptionFluidDrop decode(FriendlyByteBuf buffer) {
	    return new ParticleOptionFluidDrop().setParameters(buffer.readFloat(), buffer.readFloat(),
	...
	@Override
	public ParticleOptionFluidDrop fromCommand(ParticleType<ParticleOptionFluidDrop> pParticleType,
	...
	@Override
	public ParticleOptionFluidDrop fromNetwork(ParticleType<ParticleOptionFluidDrop> pParticleType,
