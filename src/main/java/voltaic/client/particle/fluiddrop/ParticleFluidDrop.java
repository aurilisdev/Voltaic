...
public class ParticleFluidDrop extends TextureSheetParticle {
    ...
    public ParticleFluidDrop(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed,
    ...
    public static class Factory implements ParticleProvider<ParticleOptionFluidDrop>,
	    ParticleEngine.SpriteParticleRegistration<ParticleOptionFluidDrop> {
	...
	@Override
	public Particle createParticle(ParticleOptionFluidDrop type, ClientLevel level, double x, double y, double z,
