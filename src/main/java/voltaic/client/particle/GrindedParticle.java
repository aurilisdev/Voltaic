...
public class GrindedParticle extends TextureSheetParticle {
    ...
    public GrindedParticle(ClientLevel world, double x, double y, double z, double motionX, double motionY,
	    double motionZ, BlockState state) {
	...
	int j = LevelRenderer.getLightColor(level,
