...
public class ParticleOptionPlasmaBall extends ParticleType<ParticleOptionPlasmaBall> implements ParticleOptions {
    ...
    public static final Codec<ParticleOptionPlasmaBall> CODEC = RecordCodecBuilder.create(instance -> instance
    ...
    public static final StreamCodec<FriendlyByteBuf, ParticleOptionPlasmaBall> STREAM_CODEC = CodecUtils.composite(
	    StreamCodec.FLOAT, instance0 -> instance0.scale, StreamCodec.FLOAT, instance0 -> instance0.gravity,
	    StreamCodec.INT, instance0 -> instance0.maxAge, StreamCodec.INT, instance0 -> instance0.r, StreamCodec.INT,
	    instance0 -> instance0.g, StreamCodec.INT, instance0 -> instance0.b, StreamCodec.INT,
	    instance0 -> instance0.a, (scale, gravity, age, r, g, b, a) -> new ParticleOptionPlasmaBall()
	...
	@Override
	public ParticleOptionPlasmaBall fromCommand(ParticleType<ParticleOptionPlasmaBall> type, StringReader reader)
	...
	@Override
	public ParticleOptionPlasmaBall fromNetwork(ParticleType<ParticleOptionPlasmaBall> type,
	...
	return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", scale: " + scale + ", gravity: "
		+ gravity + ", maxAge: " + maxAge + ", r: " + r + ", g: " + g + ", b: " + b + ", a: " + a;
    }
