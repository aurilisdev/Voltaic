...
public class ParticleOptionLavaWithPhysics extends ParticleType<ParticleOptionLavaWithPhysics>
    ...
    public static final Codec<ParticleOptionLavaWithPhysics> CODEC = RecordCodecBuilder.create(instance -> instance
	    ...
	    .apply(instance, (scale, lifetime, bounceFactor) -> new ParticleOptionLavaWithPhysics().setParameters(scale,
		    lifetime, bounceFactor)));
	...
	public ParticleOptionLavaWithPhysics decode(FriendlyByteBuf buffer) {
	    return new ParticleOptionLavaWithPhysics().setParameters(buffer.readFloat(), buffer.readInt(),
		    buffer.readDouble());
	}
    };
	...
	@Override
	public ParticleOptionLavaWithPhysics fromCommand(ParticleType<ParticleOptionLavaWithPhysics> pParticleType,
	...
	@Override
	public ParticleOptionLavaWithPhysics fromNetwork(ParticleType<ParticleOptionLavaWithPhysics> pParticleType,
	...
	return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", scale: " + scale + ", bounceFactor: "
		+ bounceFactor + ", lifetime: " + lifetime;
    }
