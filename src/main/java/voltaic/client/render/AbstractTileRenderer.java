...
public abstract class AbstractTileRenderer<T extends GenericTile> extends TileEntityRenderer<T> {
	...
	public void renderItem(ItemStack stack, TransformType context, int light, int overlay, MatrixStack poseStack, IRenderTypeBuffer bufferSource, @Nullable World world, int seed) {
