		...
		event.getTooltipElements()
			.add(Either
				.left(VoltaicTextUtils
					.tooltip("radiationshieldingamount",
						ChatFormatter.getChatDisplayShort(shielding.amount(), DisplayUnits.RAD)
							.withStyle(ChatFormatting.GRAY))
					.withStyle(ChatFormatting.DARK_GRAY)));
		// event.getTooltipElements().add(Either.left(NuclearTextUtils.tooltip("radiationshieldinglevel",
		// Component.literal(shielding.level() +
