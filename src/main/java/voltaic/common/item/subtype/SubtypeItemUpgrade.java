...
public enum SubtypeItemUpgrade implements ISubtype {
    ...
    SubtypeItemUpgrade(TriConsumer<GenericTile, ItemStack, Integer> applyUpgrade, int maxSize, IFormattableTextComponent name, String... modIds) {
    ...
    SubtypeItemUpgrade(int maxStackSize, IFormattableTextComponent name, String... modIds) {
