...
public class ItemGuidebook extends ItemVoltaic {
	...
	if (world.isClientSide) {
		...
		player.sendSystemMessage(VoltaicTextUtils.chatMessage("guidebookclick")
	...
	return new SimpleMenuProvider((id, inv, play) -> new ContainerGuidebook(id, player.getInventory()),
		CONTAINER_TITLE);
    }
