...
public abstract class FluidItem2GasRecipe extends AbstractMaterialRecipe {
    ...
    public FluidItem2GasRecipe(ResourceLocation group, List<CountableIngredient> inputItems,
	...
	T create(ResourceLocation group, List<CountableIngredient> inputItems, List<FluidIngredient> inputFluids,
