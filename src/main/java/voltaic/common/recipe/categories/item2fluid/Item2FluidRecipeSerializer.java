...
public class Item2FluidRecipeSerializer<T extends Item2FluidRecipe> extends VoltaicRecipeSerializer<T> {
	...
	super(CodecUtils.composite(StreamCodec.RESOURCE_LOCATION, T::getId, CountableIngredient.LIST_STREAM_CODEC,
		T::getCountedIngredients, StreamCodec.FLUID_STACK, T::getFluidRecipeOutput, StreamCodec.DOUBLE,
		T::getXp, StreamCodec.INT, T::getTicks, StreamCodec.DOUBLE, T::getUsagePerTick,
