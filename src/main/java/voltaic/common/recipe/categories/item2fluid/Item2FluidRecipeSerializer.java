...
public class Item2FluidRecipeSerializer<T extends Item2FluidRecipe> extends VoltaicRecipeSerializer<T> {
	...
	streamCodec = CodecUtils.composite(ByteBufCodecs.STRING_UTF8, T::getGroup,
		CountableIngredient.LIST_STREAM_CODEC, T::getCountedIngredients, FluidStack.STREAM_CODEC,
		T::getFluidRecipeOutput, ByteBufCodecs.DOUBLE, T::getXp, ByteBufCodecs.INT, T::getTicks,
