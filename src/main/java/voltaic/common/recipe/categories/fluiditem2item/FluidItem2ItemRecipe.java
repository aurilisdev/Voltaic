...
public abstract class FluidItem2ItemRecipe extends AbstractMaterialRecipe {
    ...
    public FluidItem2ItemRecipe(ResourceLocation group, List<CountableIngredient> itemInputs,
	...
	T create(ResourceLocation group, List<CountableIngredient> itemInputs, List<FluidIngredient> fluidInputs,
