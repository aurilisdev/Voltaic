...
public abstract class Fluid2ItemRecipe extends AbstractMaterialRecipe {
    ...
    public Fluid2ItemRecipe(ResourceLocation group, List<FluidIngredient> fluidInputs, ItemStack itemOutput,
	...
	T create(ResourceLocation group, List<FluidIngredient> fluidInputs, ItemStack itemOutput, double experience,
