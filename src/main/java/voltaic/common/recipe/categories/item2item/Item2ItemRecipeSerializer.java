...
public class Item2ItemRecipeSerializer<T extends Item2ItemRecipe> extends VoltaicRecipeSerializer<T> {
	...
	super(CodecUtils.composite(StreamCodec.RESOURCE_LOCATION, T::getId, CountableIngredient.LIST_STREAM_CODEC,
		T::getCountedIngredients, StreamCodec.ITEM_STACK, T::getItemRecipeOutput, StreamCodec.DOUBLE, T::getXp,
     ...
     * ItemStack output = buffer.readItem(); double experience =
     ...
     * 
     * @Override public void toNetwork(FriendlyByteBuf buffer, Item2ItemRecipe
     * recipe) { buffer.writeUtf(recipe.getGroup());
