...
public class Item2ItemRecipeSerializer<T extends Item2ItemRecipe> extends VoltaicRecipeSerializer<T> {
	...
	streamCodec = CodecUtils.composite(ByteBufCodecs.STRING_UTF8, T::getGroup,
		CountableIngredient.LIST_STREAM_CODEC, T::getCountedIngredients, ItemStack.STREAM_CODEC,
		T::getItemRecipeOutput, ByteBufCodecs.DOUBLE, T::getXp, ByteBufCodecs.INT, T::getTicks,
		ByteBufCodecs.DOUBLE, T::getUsagePerTick, ProbableItem.LIST_STREAM_CODEC, T::getItemBiproducts,
		ProbableFluid.LIST_STREAM_CODEC, T::getFluidBiproducts, ProbableGas.LIST_STREAM_CODEC,
		T::getGasBiproducts, factory::create);
    }
