...
public class FluidItem2FluidRecipeSerializer<T extends FluidItem2FluidRecipe> extends VoltaicRecipeSerializer<T> {
	...
	super(CodecUtils.composite(StreamCodec.RESOURCE_LOCATION, T::getId, CountableIngredient.LIST_STREAM_CODEC,
		T::getCountedIngredients, FluidIngredient.LIST_STREAM_CODEC, T::getFluidIngredients,
		StreamCodec.FLUID_STACK, T::getFluidRecipeOutput, StreamCodec.DOUBLE, T::getXp, StreamCodec.INT,
		T::getTicks, StreamCodec.DOUBLE, T::getUsagePerTick, ProbableItem.LIST_STREAM_CODEC,
     ...
     * FluidStack output = buffer.readFluidStack(); double experience =
