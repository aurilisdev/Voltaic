...
public class Fluid2FluidRecipeSerializer<T extends Fluid2FluidRecipe> extends VoltaicRecipeSerializer<T> {
	...
	streamCodec = CodecUtils.composite(ByteBufCodecs.STRING_UTF8, T::getGroup, FluidIngredient.LIST_STREAM_CODEC,
		T::getFluidIngredients, FluidStack.STREAM_CODEC, T::getFluidRecipeOutput, ByteBufCodecs.DOUBLE,
		T::getXp, ByteBufCodecs.INT, T::getTicks, ByteBufCodecs.DOUBLE, T::getUsagePerTick,
