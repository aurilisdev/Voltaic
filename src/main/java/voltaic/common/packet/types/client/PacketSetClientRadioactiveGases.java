...
public class PacketSetClientRadioactiveGases {
    ...
    public static final StreamCodec<FriendlyByteBuf, PacketSetClientRadioactiveGases> CODEC = new StreamCodec<>() {
	@Override
	...
	public void encode(FriendlyByteBuf buf, PacketSetClientRadioactiveGases packet) {
		...
		GasStack.STREAM_CODEC.encode(buf,
			new GasStack(entry.getKey(), 1, Gas.ROOM_TEMPERATURE, Gas.PRESSURE_AT_SEA_LEVEL));
