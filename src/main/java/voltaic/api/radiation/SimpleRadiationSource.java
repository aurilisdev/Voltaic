...
public class SimpleRadiationSource implements IRadiationSource {
	...
	public SimpleRadiationSource decode(ByteBuf buffer) {
	    return new SimpleRadiationSource(ByteBufCodecs.DOUBLE.decode(buffer), ByteBufCodecs.DOUBLE.decode(buffer),
		    ByteBufCodecs.INT.decode(buffer), ByteBufCodecs.BOOL.decode(buffer),
		    ByteBufCodecs.INT.decode(buffer), BlockPos.STREAM_CODEC.decode(buffer),
