 ...
 * <p>
 * Implementations of this are capability-based and will handle the distribution
 * of radiation to radiation recipients within its perview. The assumption is
 * that implementations of this will use ray casting to apply radiation effects
 * to surrounding recipients, however the logic is left to the implementer. It
 * is also assumed this manager will be ticked to perform its logic.
 *
 */
public interface IRadiationManager {

    /**
     * A list of all permanent radiation sources currently handled by this manager.
     * You should not remove items from this list.
     *
     * @return
     */
    ...
    /**
     * Adds a radiation source to this manager. The manager will then categorize it
     * accordingly
     *
     * @param source
     */
    ...
    /**
     * The default rate at which this manager will disipate any
     * FadingRadiationSources
     *
     ...
     * @param shouldLeaveFadingSource Whether the removed source should leave behind
     *                                a fading radiation source
     * @return
     */
    ...
    /**
     * A wrapper class that represents a radiation source that has been removed.
     * Just because the source of radiation itself is gone doesn't mean the
     * radiation immediately disipates.
     *
     * @author skip999
     */
	...
	public static final Codec<FadingRadiationSource> CODEC = RecordCodecBuilder.create(
		instance -> instance.group(Codec.INT.fieldOf("distance").forGetter(instance0 -> instance0.distance),
			...
			BlockPos.CODEC.optionalFieldOf("position", BlockEntityUtils.OUT_OF_REACH)
				.forGetter(instance0 -> instance0.position)
	...
	public static final Codec<TemporaryRadiationSource> CODEC = RecordCodecBuilder
		.create(instance -> instance.group(Codec.INT.fieldOf("ticks").forGetter(instance0 -> instance0.ticks),
			Codec.DOUBLE.fieldOf("strength").forGetter(instance0 -> instance0.strength),
			Codec.DOUBLE.fieldOf("amount").forGetter(instance0 -> instance0.radiation),
