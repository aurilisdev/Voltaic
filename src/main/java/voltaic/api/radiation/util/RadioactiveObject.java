...
public record RadioactiveObject(double strength, double amount) {
    ...
    public static final Codec<RadioactiveObject> CODEC = RecordCodecBuilder.create(instance -> instance
	    .group(Codec.DOUBLE.fieldOf("strength").forGetter(RadioactiveObject::strength),
