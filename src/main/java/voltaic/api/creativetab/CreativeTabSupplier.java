...
public interface CreativeTabSupplier {
    ...
    /**
     * If {@code isAllowedInCreativeTab} returns true, this will add the items this
     * Item will display in the creative mode tab
     * 
    ...
    /**
     * This method will check if a block has a creative tab. This method should
     * filter for things like a null creative tab or similar
     * 
     * @return
     */
