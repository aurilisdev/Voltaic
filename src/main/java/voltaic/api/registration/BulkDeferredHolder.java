...
/**
 * A wrapper class intended to house much of the functionality of the Subtype
 * HashMaps
 * 
 * @param <T>       The base class of the registered object i.e. Fluid, Item,
 *                  etc.
 * @param <A>       The class of the registered object; must extend the base
 *                  class
