...
public class Gas {
    ...
    public Gas(Supplier<Item> container, Component description, int condensationTemp, Color color,
	    Supplier<Fluid> condensedFluid) {
	this.container = container;
	this.description = description;
	...
	return description.getString() + ",\tcondensation temp : " + condensationTemp + " K,\tcondensed fluid: "
		+ getCondensedFluid().getFluidType().getDescription().getString();
    }
