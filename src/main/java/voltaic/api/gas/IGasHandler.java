...
public interface IGasHandler {
    ...
    /**
     * @param tank : The tank to check.
     * @return An integer representing the maximum storage capacity of the checked
     *         tank.
     */
    ...
    /**
     * @param tank : The tank to check.
     * @return An integer representing the maximum temperature (in degrees Kelvin)
     *         of the checked tank
     */
    ...
    /**
     * @param tank : The tank to check
     * @return A double representing the maximum pressure (in ATM) of the checked
     *         tank
     */
     ...
     * @return How much room is left in the tank after the gas is heated. A VALUE OF
     *         NEGATIVE ONE INDICATES THERE IS NOT ENOUGH ROOM.
     */
     ...
     * @return How much room is left in the tank after the gas is pressurized. A
     *         VALUE OF NEGATIVE ONE INDICATES THERE IS NOT ENOUGH ROOM.
     */
