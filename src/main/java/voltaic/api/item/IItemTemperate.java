...
public interface IItemTemperate {
    ...
    /**
     * Decreases the temperature of the item and returns the amount the temperature
     * actually decreased
     * 
     * @param stack:   The item being cooled
     * @param amount:  The amount to decrease the temperature by. This value should
     *                 always be positive
     ...
     * @param amount: The amount to heat the item by. This value should always be
     *                positive
     * @param debug:  If this should be simulated or not
