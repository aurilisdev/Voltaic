...
/**
 * Almost carbon copy of Forge's FluidHandlerItemStack capability, except the
 * way you validate fluids actually makes sense and I don't have to bolt on a
 * bunch of random crap to make it work
 * 
 * @author skip999
 */
