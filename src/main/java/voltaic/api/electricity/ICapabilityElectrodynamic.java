...
/**
 * CONVENTION NOTE: A VOLTAGE OF -1 INDICATES THIS ENTITY SHOULD NOT HAVE
 * VOLTAGE CONSIDERED WHEN INTERACTING WITH IT
 * 
...
public interface ICapabilityElectrodynamic {
	...
	return VoltaicCapabilities.DEFAULT_VOLTAGE;
    }
    ...
    /**
     * The energy that this Capability received that triggered the over-voltage
     * condition
     * 
     * @param transfer
     */
    ...
    /**
     * A hook method that is called by convention when a value on this Capabiliy
     * changes
     */
    void onChange();
     ...
     * 
     * @return The voltage of the return is assumed to be the operating voltage of
     *         this Capability when this is called
     */
    TransferPack getConnectedLoad(LoadProfile loadProfile, Direction dir);

    /**
     * @param lastUsage:        represents the last known energy usage of this
     *                          device
     * @param maximumAvailable: represents the theoretical maximum amount of energy
     *                          this device could receive
     * 
     * @author skip999
     *
     */
