...
public interface IMultiblockParentTile {
     ...
     * Okay so hear me out:
     *
     * Yes, using an array is a little more confusing, however it gives a fixed
     * index to a subnode
     *
     * This is useful as it means a subnode can look itself up on the parent tile
     * really quickly and reliably if there's a data point it needs to reference
     *
     *
     */
    ...
    @Nullable
    default ICapabilityElectrodynamic getSubnodeElectrodynamicCapability(TileMultiSubnode subnode,
