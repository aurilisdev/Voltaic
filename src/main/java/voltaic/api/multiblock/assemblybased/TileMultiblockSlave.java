...
public class TileMultiblockSlave extends TileReplaceable {
    ...
    public final SingleProperty<BlockPos> controller = property(
	    new SingleProperty<>(PropertyTypes.BLOCK_POS, "controllerpos", BlockEntityUtils.OUT_OF_REACH))
	    .onTileLoaded(prop -> {
    ...
    public final SingleProperty<ResourceLocation> renderModel = property(
	    new SingleProperty<>(PropertyTypes.RESOURCE_LOCATION, "model", MultiblockSlaveNode.NOMODEL));
