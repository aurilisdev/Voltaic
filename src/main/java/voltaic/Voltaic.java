...
public class Voltaic {
	...
	RadiationShieldingRegister.INSTANCE = new RadiationShieldingRegister()
	...
	event.enqueueWork(() -> {
	    VoltaicRegistries.gasRegistry()
		    .forEach(gas -> VoltaicGases.MAPPED_GASSES.put(gas.getCondensedFluid(), gas));
	});
    ...
    // This will only be accurate after FMLCommonSetupEvent has fired, meaning if
    // you
