...
public class TransferPack {
    ...
    public static final Codec<TransferPack> CODEC = RecordCodecBuilder.create(instance -> instance
	    .group(Codec.DOUBLE.fieldOf("joules").forGetter(TransferPack::getJoules),
    ...
    public static final StreamCodec<FriendlyByteBuf, TransferPack> STREAM_CODEC = StreamCodec.composite(
	    ByteBufCodecs.DOUBLE, TransferPack::getJoules, ByteBufCodecs.DOUBLE, TransferPack::getVoltage,
	    TransferPack::new);
