...
public class RenderingUtils {
	...
	try {
		...
		vertexconsumer2.addVertex(matrix4f, 0.0F, 0.0F, 0.0F).setColor((int) (255 * r), (int) (255 * g),
			(int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, -0.866f * f4, f3, -0.5F * f4).setColor((int) (255 * r),
			(int) (255 * g), (int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, -0.866f * f4, f3, -0.5F * f4).setColor((int) (255 * r),
			(int) (255 * g), (int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, 0.0F, 0.0F, 0.0F).setColor((int) (255 * r), (int) (255 * g),
			(int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, -0.866f * f4, f3, -0.5F * f4).setColor((int) (255 * r),
			(int) (255 * g), (int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, 0.0F, f3, 1.0F * f4).setColor((int) (255 * r), (int) (255 * g),
			(int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, 0.0F, 0.0F, 0.0F).setColor((int) (255 * r), (int) (255 * g),
			(int) (255 * b), (int) (255 * a));
		vertexconsumer2.addVertex(matrix4f, -0.866f * f4, f3, -0.5F * f4).setColor((int) (255 * r),
	...
	renderFilledBox(stack, builder, box, color.rFloat(), color.gFloat(), color.bFloat(), color.aFloat(), sp.getU0(),
		sp.getV0(), sp.getU1(), sp.getV1(), light, overlay, renderedFaces);
    }
	...
	// Down
	if (renderedFaces[0]) {
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, -1, 0);
	}

	// Up
	if (renderedFaces[1]) {
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 1, 0);
	}

	// North
	if (renderedFaces[2]) {
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, -1);
	}

	// South
	if (renderedFaces[3]) {
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 0, 0, 1);
	}

	// West
	if (renderedFaces[4]) {
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, -1, 0, 0);
	}
	...
	if (renderedFaces[5]) {
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMin).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMax).setOverlay(overlay)
		    .setLight(light).setNormal(pose, 1, 0, 0);
	}
	...
	// Down
	if (renderedFaces[0]) {
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, -1, 0);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, -1, 0);
	}

	// Up
	if (renderedFaces[1]) {
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 1, 0);
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 1, 0);
	}

	// North
	if (renderedFaces[2]) {
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, -1);
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, -1);
	}

	// South
	if (renderedFaces[3]) {
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, 1);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 0, 0, 1);
	}

	// West
	if (renderedFaces[4]) {
	    builder.addVertex(matrix4f, minX, maxY, maxZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, maxY, minZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, minY, minZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, -1, 0, 0);
	    builder.addVertex(matrix4f, minX, minY, maxZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, -1, 0, 0);
	}
	...
	if (renderedFaces[5]) {
	    builder.addVertex(matrix4f, maxX, maxY, minZ).setColor(r, g, b, a).setUv(uMin, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, maxY, maxZ).setColor(r, g, b, a).setUv(uMax, vMin)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, minY, maxZ).setColor(r, g, b, a).setUv(uMax, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 1, 0, 0);
	    builder.addVertex(matrix4f, maxX, minY, minZ).setColor(r, g, b, a).setUv(uMin, vMax)
		    .setOverlay(OverlayTexture.NO_OVERLAY).setLight(light).setNormal(pose, 1, 0, 0);
	}
	...
	try {
	    ...
	    minecraft.getItemRenderer().render(stack, ItemDisplayContext.GUI, false, poseStack, graphics.bufferSource(),
    ...
    public static void blitCustomShader(PoseStack matrixStack, int x, int y, int u, int v, int textWidth,
	    int textHeight, int imgWidth, int imgHeight, Supplier<ShaderInstance> shader) {
	// blit(matrixStack, x, y, textWidth, textHeight, u, v, textWidth, textHeight,
	// imgWidth, imgHeight);
	// innerBlit(matrixStack, x, x + textWidth, y, y + textHeight, 0, textWidth,
	// textHeight, u, v, imgWidth, imgHeight);
	// innerBlit(matrixStack.last().pose(), x, x + textWidth, y, y + textHeight, 0,
	// (u + 0.0F) / (float) imgWidth, (u + (float)
	// textWidth) / (float) imgWidth, (v + 0.0F) / (float) imgHeight, (v + (float)
	// textHeight) / (float) imgHeight);
