...
public class SoundBarrierMethods {
	...
	public static <T extends TileEntity & ITickableSound> void playTileSound(SoundEvent event, T tile, double range, boolean repeat) {
	...
	public static <T extends TileEntity & ITickableSound> void playTileSound(SoundEvent event, SoundCategory source, T tile, float volume, float pitch, double range, boolean repeat) {
