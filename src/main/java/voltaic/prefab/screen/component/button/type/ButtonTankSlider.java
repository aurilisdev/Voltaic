...
public class ButtonTankSlider extends ScreenComponentButton<ButtonTankSlider> {
	...
	private TankSliderTextures(int textureWidth, int textureHeight, int textureU, int textureV, int imageWidth,
		int imageHeight) {
	    ...
	    loc = Voltaic.rl("textures/screen/component/button/tankarrows.png");
	}
