...
public class ScreenComponentButton<T extends ScreenComponentButton<?>> extends ScreenComponentGeneric {
    ...
    public static final WidgetSprites VANILLA_BUTTON_SPRITES = new WidgetSprites(Voltaic.vanillarl("widget/button"),
	    Voltaic.vanillarl("widget/button_disabled"), Voltaic.vanillarl("widget/button_highlighted"));
