...
public class ScreenComponentVerticalSlider extends ScreenComponentGeneric {
	...
	if (sliderDragConsumer != null) {
	    sliderDragConsumer.accept((int) (mouseY - requireScreen().getGuiHeight()));
	}
	...
	if (!isHeld && isPointInSlider(xLocation, yLocation, mouseX - requireScreen().getGuiWidth(),
	    ...
	    sliderClickConsumer.accept((int) (mouseY - requireScreen().getGuiHeight()));
	}
	...
	return xAxis >= x && xAxis <= x + width - 1 && yAxis >= y + sliderYOffset + 2
		&& yAxis <= y + 2 + sliderYOffset + 15;
    }
	...
	SLIDER_BACKGROUND(14, 30, 0, 0, 14, 30,
		Voltaic.rl("textures/screen/component/verticalslider/vertical_slider_bg.png")),
	SLIDER_ACTIVE(12, 15, 0, 0, 12, 15,
		Voltaic.rl("textures/screen/component/verticalslider/vertical_slider_active.png")),
	SLIDER_INACTIVE(12, 15, 0, 0, 12, 15,
		Voltaic.rl("textures/screen/component/verticalslider/vertical_slider_inactive.png"));
	...
	private VerticalSliderTextures(int textureWidth, int textureHeight, int textureU, int textureV, int imageWidth,
