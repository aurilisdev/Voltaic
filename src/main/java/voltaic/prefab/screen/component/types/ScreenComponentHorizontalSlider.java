...
public class ScreenComponentHorizontalSlider extends ScreenComponentGeneric {
	...
	return xAxis >= x + sliderXOffset + 2 && xAxis <= x + 2 + sliderXOffset + 15 && yAxis >= y
		&& yAxis <= y + height - 1;
    }
	...
	SLIDER_BACKGROUND(30, 14, 0, 0, 30, 14,
		Voltaic.rl("textures/screen/component/horizontalslider/horizontal_slider_bg.png")),
	SLIDER_ACTIVE(15, 12, 0, 0, 15, 12,
		Voltaic.rl("textures/screen/component/horizontalslider/horizontal_slider_active.png")),
	SLIDER_INACTIVE(15, 12, 0, 0, 15, 12,
		Voltaic.rl("textures/screen/component/horizontalslider/horizontal_slider_inactive.png"));
	...
	private HorizontalSliderTextures(int textureWidth, int textureHeight, int textureU, int textureV,
		int imageWidth, int imageHeight, ResourceLocation loc) {
