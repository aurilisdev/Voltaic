...
public class ScreenComponentHorizontalSlider extends ScreenComponentGeneric {
    ...
    public void renderBackground(PoseStack poseStack, int xAxis, int yAxis, int guiWidth, int guiHeight) {
        ...
        blit(poseStack, guiWidth + xLocation - 1, guiHeight + yLocation, 1, height, bg.textureU(), bg.textureV(), 1, bg.textureHeight(), bg.imageWidth(), bg.imageHeight());
        ...
        for (int i = 0; i < permutations; i++) {
        	...
        	blit(poseStack, guiWidth + xLocation + i * 28, guiHeight + yLocation, 28, height, bg.textureU() + 1, bg.textureV(), 28, bg.textureHeight(), bg.imageWidth(), bg.imageHeight());

        }

        blit(poseStack, guiWidth + xLocation + 28 * permutations, guiHeight + yLocation, remainder, height, bg.textureU() + 1, bg.textureV(), remainder, bg.textureHeight(), bg.imageWidth(), bg.imageHeight());

        blit(poseStack, guiWidth + xLocation + width - 2, guiHeight + yLocation, 1, height, bg.textureU() + 29, bg.textureV(), 1, bg.textureHeight(), bg.imageWidth(), bg.imageHeight());
        ...
        blit(poseStack, guiWidth + xLocation + sliderXOffset , guiHeight + yLocation + 1, slider.textureWidth(), slider.textureHeight(), slider.textureU(), slider.textureV(), slider.textureWidth(), slider.textureHeight(), slider.imageWidth(), slider.imageHeight());
