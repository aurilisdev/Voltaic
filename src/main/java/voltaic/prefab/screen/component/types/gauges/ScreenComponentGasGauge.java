...
public class ScreenComponentGasGauge extends ScreenComponentGeneric {
	...
	IGasHandlerItem handler = stack.getCapability(VoltaicCapabilities.CAPABILITY_GASHANDLER_ITEM).resolve()
	...
	if (taken > 0) {
	    ...
	    NetworkHandler.CHANNEL.sendToServer(new PacketUpdateCarriedItemServer(stack.copy(),
