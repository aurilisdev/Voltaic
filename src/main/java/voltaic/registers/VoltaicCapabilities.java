...
public class VoltaicCapabilities {
    ...
    public static final ItemCapability<ILocationStorage, Void> CAPABILITY_LOCATIONSTORAGE_ITEM = ItemCapability
	    .createVoid(Voltaic.rl("locationstorageitem"), ILocationStorage.class);
    ...
    public static final EntityCapability<IRadiationRecipient, Void> CAPABILITY_RADIATIONRECIPIENT = EntityCapability
	    .createVoid(Voltaic.rl("radiationrecipient"), IRadiationRecipient.class);
	...
	BuiltInRegistries.ENTITY_TYPE.forEach(entry -> event.registerEntity(CAPABILITY_RADIATIONRECIPIENT, entry,
		(entity, context) -> new CapabilityRadiationRecipient()));
