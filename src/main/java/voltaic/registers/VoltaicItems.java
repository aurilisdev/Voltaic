...
public class VoltaicItems {
    ...
    public static final RegistryObject<ItemGuidebook> GUIDEBOOK = ITEMS.register("guidebook",
    ...
    // public static final RegistryObject<Item> ITEM_IODINETABLET =
    // ITEMS.register("iodinetablet", () -> new ItemIodineTablet(new
    // Item.Properties(), VoltaicAPICreativeTabs.MAIN));

    public static final BulkRegistryObject<ItemUpgrade, SubtypeItemUpgrade> ITEMS_UPGRADE = new BulkRegistryObject<>(
